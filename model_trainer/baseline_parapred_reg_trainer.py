...
from models.parapred_reg import ParapredReg
import numpy as np
import random
import torch
import math
...
class Trainer(object):
    ...
    def build_model(self):
        self.model = ParapredReg(
            amino_ft_dim=self.param_dict['amino_type_num'],
    ...
    def iteration(self, epoch, dataloader, is_training=False):
        ...
        for antibody_ft, virus_ft, pair_label, antibody_len, virus_len in dataloader:
            ...
            pred = pred.view(-1)
            if is_training:
                r_loss = F.mse_loss(pred, pair_label, reduction='mean')
                param_l2_loss = 0
                param_l1_loss = 0
