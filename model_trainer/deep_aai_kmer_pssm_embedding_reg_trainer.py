...
from models.deep_aai_kmer_pssm_embedding_reg import DeepAAIKmerPssmEmbeddingReg
import numpy as np
import random
import torch
import math
...
class Trainer(object):
    ...
    def build_model(self):
        self.model = DeepAAIKmerPssmEmbeddingReg(**self.param_dict).to(self.device)
