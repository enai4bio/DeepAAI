...
class DeepAAIPssmEmbeddingReg(nn.Module):
    def __init__(self, **param_dict):
        super(DeepAAIPssmEmbeddingReg, self).__init__()
    ...
    def forward(self, **ft_dict):
        ...
        antibody_node_ft = antibody_node_pssm_ft
        ...
        virus_node_ft = virus_node_pssm_ft
