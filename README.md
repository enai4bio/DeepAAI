...
Zhang, J., Du, Y., Zhou, P. et al. Predicting unseen antibodies’ neutralizability via adaptive graph neural networks. _Nature Machine Intelligence_ **4**, 964–976 (2022). 
